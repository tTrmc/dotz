...
from dotkeep.core import init_repo, add_dotfile, save_tracked_dir
...
class TestWatcherIntegration:
    ...
    def test_on_created_tracks_matching_file(self, mock_add_dotfile, initialized_dotkeep):
    ...
    @patch('dotkeep.watcher.add_dotfile')
    def test_on_created_ignores_non_matching_file(self, mock_add_dotfile, initialized_dotkeep):
    ...
    @patch('dotkeep.watcher.add_dotfile')
    def test_on_created_ignores_directories(self, mock_add_dotfile, initialized_dotkeep):
...
class TestWatcherWithCustomConfig:
    ...
    def test_case_sensitivity_config(self, initialized_dotkeep):
        ...
        from dotkeep.core import set_config_value, add_file_pattern, reset_config
...
class TestWatcherErrorHandling:
    ...
    def test_handler_with_missing_config_keys(self, initialized_dotkeep):
        ...
        from dotkeep.core import save_config, reset_config
