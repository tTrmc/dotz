...
class TestConfigurationManagement:
    ...
    def test_load_config_with_existing_file(self):
        ...
        config_data = {
            ...
            "search_settings": {"recursive": False},
        }
    ...
    def test_save_config(self):
        ...
        self.dotz_dir.mkdir()
        config_data = {"file_patterns": {"include": ["*.py"], "exclude": ["*.pyc"]}}
...
class TestGitOperations:
    ...
    def test_init_repo_with_remote(self):
        ...
        with (
            patch("dotz.core.Repo.init") as mock_init,
...
class TestPatternMatching:
    ...
    def test_matches_exclude_patterns(self):
        ...
        assert not core.matches_patterns(
            "error.log", include_patterns, exclude_patterns
        )
